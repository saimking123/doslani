    ...
    ?>
        ...
        <div class="shop__section section--padding">
            ...
            if (isset($_GET['search'])) {
                ...
                $query = "SELECT p.*, si.subcategory_images
          FROM product p
                        ...
                        <div id="product_grid" class="tab_pane active show">
                            <div class="product__section--inner">
                                <div class="row mb--n30">
                                    <?php
                                    while ($rows = mysqli_fetch_assoc($query_connect)) { ?>
                                        ...
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block" href="product-details.php?pro_id=<?php echo $rows["id"] ?>">
                                                    <img class="product__card--thumbnail__img product__primary--img" src="<?php echo str_replace('../', '', $rows["image"]); ?>" style="width: 300px; height: 300px;" alt="">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <div class="product__card--footer">
                                                    <a class="product__card--btn primary__btn" href="product-details.php?pro_id=<?php echo $rows["id"] ?>">
        ...
        <nav class="pagination justify-content-center">
            <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                ...
                // Previous page link
                if ($currentPage > 1) {
                    echo '<li class="pagination__list"><a href="product_fetch.php?page=' . ($currentPage - 1) . '" class="pagination__item link">&lt;</a></li>';
                }

                // Page links
                for ($i = 1; $i <= $totalPages; $i++) {
                    echo '<li class="pagination__list"><a href="product_fetch.php?page=' . $i . '" class="pagination__item link">' . $i . '</a></li>';
                }
...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/shop-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Dec 2023 15:19:00 GMT -->
</html>