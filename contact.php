            ...
            <div class="container">
                ...
                <div class="main__contact--area position__relative">
                    <div class="contact__form">
                        ...
                        <form class="contact__form--inner" action="contact_backend.php" method="post">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="firstname" placeholder="Your First Name" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input2">Last Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="lastname"  placeholder="Your Last Name" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="">Phone Number <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="number"  placeholder="Phone number" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input4">Email <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="email"  placeholder="Email" type="text">
                                    </div>
                                </div>
                                <div class="col-12">
                            ...
                            <button class="contact__form--btn primary__btn" type="submit" name="contactusbtn"><span>Submit Now</span></button>  
                        </form>
                    </div>
                    ...
                    <div class="contact__info border-radius-5">
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> <a href="mailto:info@example.com">Doslani@gmail.com</a> <br> <a href="mailto:info@example.com">Doslani@gmail.com</a></p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
...
<!-- Mirrored from risingtheme.com/html/demo-partsix/partsix/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Dec 2023 15:19:07 GMT -->
</html>
